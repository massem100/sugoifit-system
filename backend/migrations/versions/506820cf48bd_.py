...
Revision ID: 506820cf48bd
Revises: 52770fae8832
Create Date: 2021-04-30 10:33:08.667972
...
revision = '506820cf48bd'
down_revision = '52770fae8832'
branch_labels = None
depends_on = None
...
def upgrade():
    ...
    sa.Column('fstmtID', sa.Integer(), nullable=True),
    ...
    sa.Column('orderID', sa.Integer(), nullable=False),
    sa.Column('detailsID', sa.Integer(), nullable=False),
