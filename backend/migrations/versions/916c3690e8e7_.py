...
Revision ID: 916c3690e8e7
Revises: 
Create Date: 2021-05-18 13:33:35.169546
...
def upgrade():
    ...
    sa.Column('avg_lead', sa.Integer(), nullable=True),
    sa.Column('longest_lead', sa.Integer(), nullable=True),
    sa.ForeignKeyConstraint(['busID'], ['business.busID'], onupdate='CASCADE', ondelete='CASCADE'),
    ...
    sa.Column('lastUpdateTime', sa.Date(), nullable=True),
