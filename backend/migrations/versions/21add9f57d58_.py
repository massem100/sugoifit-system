...
Revision ID: 21add9f57d58
Revises: efbcd869ba62
Create Date: 2021-05-10 00:39:14.088568
...
revision = '21add9f57d58'
down_revision = 'efbcd869ba62'
branch_labels = None
depends_on = None
...
def upgrade():
    ...
    op.add_column('custorder', sa.Column('dueDate', sa.Date(), nullable=True))
...
def downgrade():
    ...
    op.drop_constraint(None, 'custorder', type_='foreignkey')
    op.drop_constraint(None, 'custorder', type_='foreignkey')
    op.drop_column('custorder', 'dueDate')
