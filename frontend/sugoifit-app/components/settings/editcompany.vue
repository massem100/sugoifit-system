      ...
      >
        <b-form @submit.stop.prevent="handleSubmit()" enctype="multipart/form-data">
          ...
          <b-row class="mt-4 mx-lg-4 align-items-center mh-lg">
            <b-col md="3">
              <label class="text-info font-weight-bold">Company ID</label>
            </b-col>
          ...
          <b-row class=" mx-lg-4 align-items-center mh-lg">
            <b-col md="3">
              <label class="text-info font-weight-bold">Company Name</label>
            </b-col>
            <b-col md="9" class="font-weight-bold">
              Buisness Owner
            </b-col>
          ...
          <b-row class=" mx-lg-4 align-items-center mh-lg">
            <b-col md="3">
              <label class="text-info font-weight-bold">Company Email</label>
            </b-col>
            <b-col md="9" class="c-box">
              <validation-provider
                ...
                name="company email"
              >
                <b-form-input v-model="form.company_email"
                              type="email"
                              required
          ...
          <b-row class=" mx-lg-4 align-items-center mh-lg">
            <b-col md="3">
              <label class="text-info font-weight-bold">Company Address</label>
            </b-col>
            <b-col md="9" class="c-box">
              <b-form-textarea v-model="form.company_address"
                               rows="3"
              >
              </b-form-textarea>
            </b-col>
          ...
          <b-row class=" mx-lg-4 align-items-center mh-lg">
            <b-col md="3">
              <label class="text-info font-weight-bold">Company Telephone</label>
            </b-col>
            <b-col md="9" class="c-box">
              <b-form-input v-model="form.company_phone"
              >
              </b-form-input>
            </b-col>
          </b-row>
...
<script>
    ...
    export default {
<<<<<<< HEAD:frontend/sugoifit-app/components/settings/editcompany.vue
        name: 'EditCompany',
        layout: 'dashboard',
=======
        layout: 'DashboardLayout',
>>>>>>> main:frontend/sugoifit-app/pages/settings/edit-company.vue
        components: {
            ValidationProvider,
            ValidationObserver,
        },
