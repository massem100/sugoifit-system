    ...
    <client-only>
      <v-container fluid>
        ...
        <v-tabs-items v-model="level2Tab">
          <v-tab-item
            v-for="(item, ind3) in level2TabItems"
            :key="ind3"
          >
            <v-card v-if="ind3 == 3" class="shadow-none">
              <v-card-text>
                <template v-for="(singleItem, ind2) in formList">
                  <div :key="ind2">
                    <h6 class="text-info card-subtitle ">{{singleItem.heading}}</h6>
                    <div class="d-flex w-50 offset-lg-1" v-for="(singleSubItem, ind3) in singleItem.subItems" :key="ind3">
            ...
            <v-card v-if="ind3 == 4" class="shadow-none">
              <div>
                <v-data-table
                  :headers="headers2"
                  :items="desserts2"
                ...
                <v-card class="d-flex justify-end shadow-none p-4">
                  <div align="end">
                    <b-button pill variant="info" size="lg">add user</b-button>
                    <b-button pill variant="info" size="lg">Save</b-button>
                  </div>
                </v-card>
              </div>
            </v-card>
  ...
  export default {
    ...
    data() {
      return {
        level2Tab: null,
        level2TabItems: [
          'Settings', 'Your Profile', 'Your Company', 'Your Website', 'Your Managemnet',
        ],
        text: 'test',
        formList: [
          {
