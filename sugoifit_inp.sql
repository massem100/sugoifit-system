...
CREATE table GeneralLedger(
    ...
    FOREIGN KEY (accName) REFERENCES Account() 
    ON DELETE CASCADE 
    ON UPDATE CASCADE
);

CREATE table Asset(
    asset_id INT NOT NOT NULL AUTO_INCREMENT,
    a_name VARCHAR(100), 
    lifeSpan INT, 
    a_type VARCHAR(100), 
    acquisDATE DATE, 
    debitVal DECIMAL(10,2),
    creditVal DECIMAL(10,2),
    accBal DECIMAL(10.2), 
    busID INT(10) ,
    ...
    ON DELETE CASCADE
    ON UPDATE CASCADE
    FOREIGN KEY(a_name) REFERENCES Account(accName)
    ON DELETE CASCADE
    ON UPDATE CASCADE
...
CREATE table Liability(
    ...
    borw_DATE DATE, 
    loan_period INT, 
    l_debitVal DECIMAL(10,2), 
    l_creditVal DECIMAL(10,2),
    l_accBal DECIMAL(10,2), 
    busID INT(10),
